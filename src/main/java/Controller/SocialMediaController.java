...
//Got the previous two imports from Library mini project
...
public class SocialMediaController {
    //using Libary mini project LibraryController.java as a referance
    ...
    public Javalin startAPI() {
        ...
        app.post("/register",this::registerAccountHandler); //Completed
        app.post("/login", this::loginHandler);
        app.post("/messages", this::newMessageHandler); // Completed
